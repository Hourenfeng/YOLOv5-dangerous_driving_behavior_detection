    ...
    def show_pic(self):
        ...
        if success:
            ...
            if Roll == 80:
                ...
                # print(perclos)
                # 在前端UI输出perclos值
                Ui_MainWindow.printf(window, "过去80帧中，Perclos得分为" + str(round(perclos, 3)))
                # 当过去的50帧中，Perclos模型得分超过0.38时，判断为疲劳状态

                if perclos > 0.25 and perclos < 0.50:
                    # print(perclos)
                ...
                # window.label_10.setText("是否为疲劳状态")
